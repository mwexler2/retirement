...
public class JobTest {
    ...
    public void setUp() throws Exception {
        ...
        CashFlowSource job1SalarySource = new SemiMonthly(context, "semi-monthly-salary1", 5, 20,
                job1.getStartDate(), job1.getEndDate());
        job1Salary = new Salary(context, "job1Salary", "job1", job1SalarySource.getId());
        job1Salary.setBaseAnnualSalary(new BigDecimal(100000.00));
        Annual job1BonusSource = new Annual(context, "annual-bonus1", job1BonusDay,
        ...
        CashFlowSource job1SalarySource2 = new SemiMonthly(context, "semi-monthly-salary2", 10, 25, job1.getStartDate(), job1.getEndDate());
        ...
        Annual job1BonusSource2 = new Annual(context, "annual-bonus2", job1BonusDay,
                job1.getStartDate().getYear(), job1.getEndDate().getYear());
        job1Bonus2 = new BonusAnnualPct(context, "job1Bonus2", "job1", "job1Salary", job1BonusPct, job1BonusSource2.getId());

        CashFlowSource job2SalarySource = new Biweekly(context, "biweekly-job2-salary", DayOfWeek.FRIDAY, job2.getStartDate(), job2.getEndDate());
        job2Salary = new Salary(context, "job2Salary", "job2", job2SalarySource.getId());
