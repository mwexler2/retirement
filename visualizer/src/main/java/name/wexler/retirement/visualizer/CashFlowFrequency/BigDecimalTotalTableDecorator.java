 ...
 * @version $Id$
 */
public class BigDecimalTotalTableDecorator extends TableDecorator
{

    /**
     * Logger.
     */
    private static Log log = LogFactory.getLog(BigDecimalTotalTableDecorator.class);
    ...
    public String startRow()
    {
        ...
        for (Iterator it = tableModel.getHeaderCellList().iterator(); it.hasNext();)
        {
            ...
            if (cell.isTotaled())
            {
                ...
                BigDecimal previousSubTotal = subTotals.getOrDefault(totalPropertyName, BigDecimal.ZERO);
                BigDecimal previousGrandTotals = grandTotals.getOrDefault(totalPropertyName, BigDecimal.ZERO);
