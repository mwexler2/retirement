...
public class TaxTableTest {
    ...
    private final static BigDecimal STANDARD_DEDUCTION = BigDecimal.valueOf(24800.00);
    ...
    public void computeTax() throws TaxTable.TaxYearNotFoundException {
        if (expectedException != null)
            ...
            assertThat("Tax for " + year + " and $ " + income,
                    actualTax,
                    closeTo(expectedTax, BigDecimal.valueOf(0.001)));
        }
    }
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                {2021, STANDARD_DEDUCTION, BigDecimal.ZERO, null},
                {2021, STANDARD_DEDUCTION.add(BigDecimal.ONE), BigDecimal.valueOf(0.1000), null},
                {2021, STANDARD_DEDUCTION.add(BigDecimal.valueOf(19900.00)), BigDecimal.valueOf(1990.00), null},
                {2021, STANDARD_DEDUCTION.add(BigDecimal.valueOf(172751.00)), BigDecimal.valueOf(29502.24), null},
                {2021, STANDARD_DEDUCTION.add(BigDecimal.valueOf(329851.00)), BigDecimal.valueOf(67206.32), null},
